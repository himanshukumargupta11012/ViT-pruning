...
pretrained_model_path = os.path.join('models', 'intermodel_1.pth')
loss_type = 'cosine'
num_epochs = 10
lr = 1e-3
data_path = 'data'
...
pretrained_cifar_model_name = "facebook/deit-base-patch16-224"
...
torch.save(modified_vit_model.state_dict(), os.path.join('models', 'vit_googlebase.pth'))
