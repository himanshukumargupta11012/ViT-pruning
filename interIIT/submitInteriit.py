...
with st.expander("Results", expanded=False):
    ...
    col1, col2 = st.columns(2)
    with col1:
        st.image("images/single_img.png", caption="Testing on single image", use_column_width=True)
    with col2:
        st.image("images/multiple_img.png", caption="Testing on multiple image", use_column_width=True)
